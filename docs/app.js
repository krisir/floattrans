(() => {
  const strings = {
    zh: {
      ...
      whats3Title: "历史默认不记录",
      whats3Body: "默认不保存翻译历史；需要时可选保留期限，也可确认后删除全部记录。",
      whats4Title: "Markdown / Excel 导出",
      whats4Body: "历史记录可按日期导出为 Markdown 或 Excel，列为「序号 / 原文 / 译文」。",
      whats5Title: "设置窗口可达",
      whats5Body: "打开设置时显示 Dock 图标，可用 Dock 或 Cmd+Tab 回到设置，不必再找菜单栏。",
    ...
    en: {
      ...
      whats1Title: "Independent language pairs",
      whats1Body:
      ...
      whats3Title: "History off by default",
      whats3Body:
        "Translations are not recorded unless you opt in. Choose a retention period, or delete all records after confirmation.",
      whats4Title: "Markdown / Excel export",
      whats4Body: "Export history by day with Index / Source / Translation columns.",
      whats5Title: "Settings stays reachable",
      whats5Body:
        "Opening Settings shows FloatTrans in the Dock and Cmd+Tab, so you can return without hunting for the menu bar extra.",
      setup3:
