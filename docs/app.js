(() => {
  const strings = {
    zh: {
      ...
      heroTitle2: "看见英文",
      heroLede:
        "浮译会读取当前支持辅助功能的文本框，把正在输入的中文句子翻译成英文，并以低打扰的浮动框显示——无需复制、粘贴或快捷键。",
      ctaPrimary: "开始使用",
      ctaSecondary: "查看源码",
      point1: "实时按句翻译",
      point2: "浮动字幕低打扰",
      ...
      step2Title: "本地翻译",
      step2Body: "使用 macOS Translation 框架与本地语言模型，停顿约半秒后触发，避免输入法过程中频繁闪烁。",
      step3Title: "浮动显示",
      ...
      feat2Body: "右上角、底部居中、右下角；边距、字号、自动隐藏 3–60 秒或永不隐藏。",
      feat3Title: "应用排除",
      ...
      setup3: "在 TextEdit、浏览器等支持辅助功能的输入框中输入中文，停下片刻即可看到英文浮动框。",
    ...
    en: {
      ...
      heroLede:
        "FloatTrans reads Accessibility-capable text fields, translates the sentence you’re typing into English, and shows it in a quiet floating overlay—no copy, paste, or shortcuts.",
      ...
      step2Body:
        "Uses the macOS Translation framework and local language models. Debounces ~0.5s so IME composition doesn’t flicker.",
      ...
      feat2Body: "Top-right, bottom-center, or bottom-right. Edge inset, text size, hide after 3–60s or never.",
      ...
      setup3: "Type Chinese in TextEdit, a browser, or another Accessibility-capable field—pause briefly to see the overlay.",
